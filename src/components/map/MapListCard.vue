     ...
     <div class="single-list-item">
        <div class="single-list-item-container active-event" v-if="item.timeframe !== 'past'">
            ...
            <div class="card-content">
                ...
                <p class="single-list__group" v-if="item.listing[1] !== 'Title'"><i class="fa fa-users"></i> <a :href="'https://parkpeople.ca/groups/?n='+item.listing[2]+'&id='+item.listing[0]+'&tdgrant=true'" target="_blank"><span v-html="item.listing[1]"></span></a></p>
